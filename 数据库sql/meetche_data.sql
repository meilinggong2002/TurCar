...
-- ----------------------------
-- Table structure for meetche_admin
-- ----------------------------
DROP TABLE IF EXISTS `meetche_admin`;
CREATE TABLE `meetche_admin`  (
...
INSERT INTO `meetche_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 0, 0, 0);

-- ----------------------------
-- Table structure for meetche_fav
-- ----------------------------
DROP TABLE IF EXISTS `meetche_fav`;
CREATE TABLE `meetche_fav`  (
...
-- ----------------------------
-- Table structure for meetche_meet
-- ----------------------------
DROP TABLE IF EXISTS `meetche_meet`;
CREATE TABLE `meetche_meet`  (
...
-- ----------------------------
-- Table structure for meetche_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meetche_meet_join`;
CREATE TABLE `meetche_meet_join`  (
...
-- ----------------------------
-- Table structure for meetche_news
-- ----------------------------
DROP TABLE IF EXISTS `meetche_news`;
CREATE TABLE `meetche_news`  (
...
-- ----------------------------
-- Table structure for meetche_setup
-- ----------------------------
DROP TABLE IF EXISTS `meetche_setup`;
CREATE TABLE `meetche_setup`  (
...
-- ----------------------------
-- Table structure for meetche_user
-- ----------------------------
DROP TABLE IF EXISTS `meetche_user`;
CREATE TABLE `meetche_user`  (
