...
import com.cclinux.projects.meetche.comm.ProjectConfig;
import com.cclinux.projects.meetche.mapper.MeetJoinMapper;
...
import com.cclinux.projects.meetche.service.cust.MeetService;
...
@Service("MeetCheAdminMeetService")
public class AdminMeetService extends BaseMyAdminService {
    ...
    @Resource(name = "MeetCheMeetJoinMapper")
    private MeetJoinMapper meetJoinMapper;

    @Resource(name = "MeetCheMeetService")
    ...
    public long insertMeet(MeetModel meet) {
        appError("{4S店}该功能暂不开放，如有需要请加作者微信：cclinux0730");
