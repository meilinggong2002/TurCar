package com.cclinux.projects.meetche.service.admin;
...
import com.cclinux.projects.meetche.mapper.MeetMapper;
import com.cclinux.projects.meetche.mapper.AdminMapper;
import com.cclinux.projects.meetche.mapper.NewsMapper;
import com.cclinux.projects.meetche.mapper.UserMapper;
 ...
 */
@Service("MeetCheAdminHomeService")
public class AdminHomeService extends BaseMyAdminService {

    @Resource(name = "MeetCheAdminMapper")
    private AdminMapper adminMapper;

    @Resource(name = "MeetCheNewsMapper")
    private NewsMapper newsMapper;

    @Resource(name = "MeetCheMeetMapper")
    private MeetMapper activityMapper;

    @Resource(name = "MeetCheUserMapper")
    private UserMapper userMapper;

    @Resource(name = "MeetCheAdminMgrService")
